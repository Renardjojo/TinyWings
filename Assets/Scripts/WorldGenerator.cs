...
public class WorldGenerator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GenerateChunks((EInflexionType)Random.Range(0, (int)EInflexionType.COUNT),EType.ELLIPTIC/*(EType)Random.Range(0, (int)EType.COUNT)*/, (EChunkType)Random.Range(0, (int)EChunkType.COUNT));
        }
